...
ALTER TABLE `fkt_address` ADD CONSTRAINT FK_FKT_ADDRESS_FK_CONTACT FOREIGN KEY (`FK_CONTACT`) REFERENCES `fkt_contact` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION;
