 ...
 *******************************************************************************/
package com.sebulli.fakturama.ui.branding;
...
public interface IProductConstants {
	...
	/**
	 * A file for customizing default preference values for a product. The value
	 * is interpreted as either a URL or a bundle-relative path by the runtime.
	 * This is not referenced from the workbench.
	 * <p>
	 * The contents must be the same format as a {@link java.util.Properties}
	 ...
	 * <p>
	 * The value is a comma-separated list of four integer values, specifying x,
	 * y, width, and height of the rectangle in pixel coordinates.
	 * </p>
	 * 
	 * @since 3.2
	 * @see org.eclipse.ui.e4.IWorkbenchPreferenceConstants#SHOW_PROGRESS_ON_STARTUP
	 */
	 ...
	 * messages for reporting progress at startup should be shown. Products
	 * designed to run "headless" typically would not define this property.
	 * <p>
	 * The value is a comma-separated list of four integer values, specifying x,
	 * y, width, and height of the rectangle in pixel coordinates.
	 ...
	 * property.
	 * <p>
	 * The value is a six-digit hexadecimal number. The first two digits specify
	 * the red component of the color, the next two digits the green component,
	 * and the last two digits the blue component.
	 * </p>
	 * 
	 * @since 3.2
	 * @see org.eclipse.ui.e4.IWorkbenchPreferenceConstants#SHOW_PROGRESS_ON_STARTUP
