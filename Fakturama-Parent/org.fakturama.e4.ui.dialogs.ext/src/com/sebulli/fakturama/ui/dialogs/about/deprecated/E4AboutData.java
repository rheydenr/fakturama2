 ...
 * @since 3.0
 */
public abstract class E4AboutData {
    ...
    protected E4AboutData(String providerName, String name, String version,
            String id) {
     ...
     * @param infos
     */
    private static void reverse(E4AboutData[] infos) {
		List<E4AboutData> infoList = Arrays.asList(infos);
     ...
     */
    public static void sortByProvider(boolean reverse, E4AboutData[] infos) {
        if (reverse) {
            reverse(infos);
            return;
        }

		Arrays.sort(infos, new Comparator<E4AboutData>() {
            Collator collator = Collator.getInstance(Locale.getDefault());

			@Override
			public int compare(E4AboutData info1, E4AboutData info2) {
     ...
     *            the data to be sorted
     */
    public static void sortByName(boolean reverse, E4AboutData[] infos) {
        if (reverse) {
            reverse(infos);
            return;
        }
     ...
     *            the data to be sorted
     */
    public static void sortByVersion(boolean reverse, E4AboutData[] infos) {
        if (reverse) {
            reverse(infos);
            return;
        }
     ...
     *            the data to be sorted
     */
    public static void sortById(boolean reverse, E4AboutData[] infos) {
        if (reverse) {
            reverse(infos);
            return;
        }
