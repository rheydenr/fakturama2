 ...
 * </p>
 * 
 * @issue this class has been xcloned to org.eclipse.ui.e4.internal.ide package;
...
public interface IWorkbenchHelpContextIds {
	...
	public static final String DOCK_ON_PERSPECTIVE_ACTION = PREFIX + "dock_on_perspective_action_context"; //$NON-NLS-1$

	public static final String SHOW_TEXT_PERSPECTIVE_ACTION = PREFIX + "show_text_perspective_action_context"; //$NON-NLS-1$
	...
	public static final String CLOSE_OTHERS_ACTION = PREFIX + "close_others_action_context"; //$NON-NLS-1$
	...
	public static final String MINIMIZE_PART_ACTION = PREFIX + "minimize_part_action_context"; //$NON-NLS-1$
	...
	public static final String HELP_SEARCH_ACTION = PREFIX + "help_search_action_context"; //$NON-NLS-1$

	public static final String DYNAMIC_HELP_ACTION = PREFIX + "dynamic_help_action_context"; //$NON-NLS-1$
	...
	public static final String SYSTEM_SUMMARY_DIALOG = PREFIX + "system_summary_dialog_context"; //$NON-NLS-1$
	...
	public static final String PROBLEMS_VIEW = PREFIX + "problem_view_context";//$NON-NLS-1$
	...
	public static final String FONTS_PREFERENCE_PAGE = PREFIX + "font_preference_page_context"; //$NON-NLS-1$

	public static final String KEYS_PREFERENCE_PAGE = PREFIX + "keys_preference_page_context"; //$NON-NLS-1$

	public static final String WORKBENCH_EDITOR_PREFERENCE_PAGE = PREFIX + "workbench_editor_preference_page_context"; //$NON-NLS-1$

	public static final String CONTENT_TYPES_PREFERENCE_PAGE = PREFIX + "content_types_preference_page_context"; //$NON-NLS-1$

	public static final String WORKBENCH_PREFERENCE_PAGE = PREFIX + "workbench_preference_page_context"; //$NON-NLS-1$

	public static final String GLOBALIZATION_PREFERENCE_PAGE = PREFIX + "globalization_preference_page_context"; //$NON-NLS-1$
	...
	public static final String WORKSPACES_PREFERENCE_PAGE = PREFIX + "workspaces_preference_page_context"; //$NON-NLS-1$
	...
	public static final String CAPABILITY_PREFERENCE_PAGE = PREFIX + "capabilities_preference_page_context"; //$NON-NLS-1$
	public static final String TOGGLE_COOLBAR_ACTION = PREFIX + "toggle_coolbar_action"; //$NON-NLS-1$
}
