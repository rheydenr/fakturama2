...
public abstract class BrandingProperties {
	 ...
	 * property value should be a comma separated list of urls (either absolute
	 * or relative to the argument bundle). Tokens that do not represent a valid
	 * url will be represented with a null entry in the returned array.
	 * 
	 * @param value
	 ...
	 * image paths. Each path should either be absolute or relative to the
