 ...
 * 
 */
public class OpenExpendituresHandler {

    public static final String PARAM_LIST_TYPE = "com.sebulli.fakturama.lists.expenditurestype";
	 ...
	 * Run the action
	 * <br />
	 * Open the expenditures in an table view.
	 */
	@Execute
	public void execute(
