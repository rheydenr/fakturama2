...
//    this is for synchronizing the UI thread
    ...
    protected void postConfigureNatTable(NatTable natTable) {
        ...
        E4SelectionListener<Shipping> esl = new E4SelectionListener<>(selectionService, gridLayer.getSelectionLayer(), gridLayer.getBodyDataProvider());
...
//    	topicTreeViewer = (TopicTreeViewer<ShippingCategory>)ContextInjectionFactory.make(TopicTreeViewer.class, context);
    ...
    @Inject
    @Optional
    public void handleRefreshEvent(@UIEventTopic(ShippingEditor.EDITOR_ID) String message) {
