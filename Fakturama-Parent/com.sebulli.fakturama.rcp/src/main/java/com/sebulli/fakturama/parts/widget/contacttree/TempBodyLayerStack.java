...
public class TempBodyLayerStack<T extends DebitorAddress> extends AbstractIndexLayerTransform {
    ...
    public TempBodyLayerStack(EventList<T> eventList, IColumnPropertyAccessor<T> columnPropertyAccessor) {
    ...
    public TempBodyLayerStack(EventList<T> eventList, IColumnPropertyAccessor<T> columnPropertyAccessor, IRowIdAccessor<T> rowIdAccessor) {
