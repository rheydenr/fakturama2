...
public class DebitorListTable extends ContactListTable<Debitor> {
    ...
    private EventList<Contact> debitorListData;
...
//        Object commandId = this.listTablePart.getProperties().get("fakturama.datatable.debitors.clickhandler");
...
//        debitorListData = GlazedLists.eventList(contactDAO.findAll());
//
...
//        final FilterList<Contact> textFilteredIssues = new FilterList<Contact>(debitorListData, textMatcherEditor);
//
...
////        GlazedListsEventLayer<Contact> vatListEventLayer = new GlazedListsEventLayer<Contact>(tableDataLayer, debitorListData);
//
...
//    }
    ...
    public void handleRefreshEvent(@EventTopic("ContactEditor") String message) {
        ...
        debitorListData.clear();
        debitorListData.addAll(debitorDAO.findAll(true));
        categories.clear();
