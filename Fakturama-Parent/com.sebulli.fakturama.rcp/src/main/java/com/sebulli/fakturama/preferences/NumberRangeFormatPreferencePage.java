...
public class NumberRangeFormatPreferencePage extends FieldEditorPreferencePage {
     ...
     * 
     */
    public static final String PREFERENCES_NUMBERRANGE_PROFORMA_FORMAT = "PREFERENCES_NUMBERRANGE_PROFORMA_FORMAT";
    /**
     * 
     */
    public static final String PREFERENCES_NUMBERRANGE_DUNNING_FORMAT = "PREFERENCES_NUMBERRANGE_DUNNING_FORMAT";
    /**
     * 
     */
    public static final String PREFERENCES_NUMBERRANGE_CREDIT_FORMAT = "PREFERENCES_NUMBERRANGE_CREDIT_FORMAT";
    /**
     * 
     */
    public static final String PREFERENCES_NUMBERRANGE_CONFIRMATION_FORMAT = "PREFERENCES_NUMBERRANGE_CONFIRMATION_FORMAT";
    /**
     * 
     */
    public static final String PREFERENCES_NUMBERRANGE_ORDER_FORMAT = "PREFERENCES_NUMBERRANGE_ORDER_FORMAT";
    /**
     * 
     */
    public static final String PREFERENCES_NUMBERRANGE_OFFER_FORMAT = "PREFERENCES_NUMBERRANGE_OFFER_FORMAT";
    /**
     * 
     */
    public static final String PREFERENCES_NUMBERRANGE_DELIVERY_FORMAT = "PREFERENCES_NUMBERRANGE_DELIVERY_FORMAT";
    /**
     * 
     */
    public static final String PREFERENCES_NUMBERRANGE_INVOICE_FORMAT = "PREFERENCES_NUMBERRANGE_INVOICE_FORMAT";
    /**
     * 
     */
    public static final String PREFERENCES_NUMBERRANGE_PRODUCT_FORMAT = "PREFERENCES_NUMBERRANGE_PRODUCT_FORMAT";
    /**
     * 
     */
    public static final String PREFERENCES_NUMBERRANGE_CONTACT_FORMAT = "PREFERENCES_NUMBERRANGE_CONTACT_FORMAT";
    @Inject
    @Translation
