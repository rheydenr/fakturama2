...
public class PaymentListTable extends AbstractViewDataTable<Payment, VoucherCategory> {
    ...
    protected void postConfigureNatTable(NatTable natTable) {
        ...
        E4SelectionListener<Payment> esl = new E4SelectionListener<>(selectionService, gridLayer.getSelectionLayer(), gridLayer.getBodyDataProvider());
...
//        }
    ...
    @Inject
    @Optional
    public void handleRefreshEvent(@UIEventTopic(PaymentEditor.EDITOR_ID) String message) {
...
//	}
    ...
    public void setCategoryFilter(String filter, TreeObjectType treeObjectType) {
        currentFilter = new PaymentMatcher(filter, treeObjectType, createRootNodeDescriptor(filter));
		treeFilteredIssues.setMatcher(currentFilter);
