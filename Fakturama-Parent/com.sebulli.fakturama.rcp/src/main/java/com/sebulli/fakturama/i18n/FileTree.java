...
class FileTreeLabelProvider implements ILabelProvider {
  ...
  public FileTreeLabelProvider() {
    ...
    // Create the images
    try {
      file = new Image(null, new FileInputStream("c:\\install\\famfamfam\\icons\\page_white_text.png"));
      dir = new Image(null, new FileInputStream("c:\\install\\famfamfam\\icons\\folder.png"));
