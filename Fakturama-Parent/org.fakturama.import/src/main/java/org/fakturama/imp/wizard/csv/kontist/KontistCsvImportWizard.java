 ...
 */
public class KontistCsvImportWizard extends Wizard implements IImportWizard {
	...
	public boolean performFinish() {
		...
		if (selectedFile != null && !selectedFile.isEmpty()) {
			...
			KontistCsvImporter csvImporter = ContextInjectionFactory.make(KontistCsvImporter.class, ctx);
