...
/**
 * TODO: Vorbereitung für Extended-Format
 */
...
//        
//        // only Extended!   .withTestIndicator(factory.createIndicatorType().withIndicator(testMode));
...
//        /* only Extended .withName(createText(DocumentTypeUtil.findByBillingType(invoice.getBillingType()).name()))*/;
...
////TODO EXTENDED                .withSpecifiedTaxRegistration(createTaxNumber(invoice, ContactType.BUYER))
//                ;
//        tradeAgreement.setBuyerTradeParty(buyer);
//        
////        tradeAgreement.setSellerTaxRepresentativeTradeParty(value);
////        tradeAgreement.setProductEndUserTradeParty(null);
//            
...
//
//        // TODO tradeSettlement.setPayeeTradeParty(value);
//        
...
////        tradeSettlement.setInvoiceReferencedDocument(value);
//        
...
////          break;
////      }
//        return CurrencyCodeContentType.EUR;
//    }
//    
//    /**
...
//// TODO EXTENDED:   .withChargeFreeQuantity(value)
//// TODO EXTENDED:     .withPackageQuantity(value)
//// TODO EXTENDED:    .withShipToTradeParty(value)
//// TODO EXTENDED:   .withActualDeliverySupplyChainEvent(createSupplyChainEvent(item))
//// TODO EXTENDED:   .withDespatchAdviceReferencedDocument(value)
//// TODO EXTENDED:    .withReceivingAdviceReferencedDocument(value)
//// TODO EXTENDED:    .withDeliveryNoteReferencedDocument(value)
//                ;
//    }
//
////  /**
...
////         .withAdditionalReferencedDocument(values)
...
////            .withDirectDebitMandateID(value)
////            .withPartialPaymentAmount(value)
